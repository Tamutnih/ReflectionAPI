...
public class TestProcessor {
    /**
     * 
     * Метод находит все void методы без аргументов в классе, и запускает их.
    ...
    public static void runTest(Class<?> testClass) {
        ...
        methods.sort((o1, o2) -> {
            if (o1.isAnnotationPresent(MyTestAnnotation.class) && o2.isAnnotationPresent(MyTestAnnotation.class)) {
                return o1.getAnnotation(MyTestAnnotation.class).order()
                        - o2.getAnnotation(MyTestAnnotation.class).order();
            }
            return 0;
        });
